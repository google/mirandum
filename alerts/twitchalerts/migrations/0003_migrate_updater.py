...
def migrate_updater(apps, schema_editor):
    TwitchalertsEvent = apps.get_model("twitchalerts", "TwitchalertsEvent")
    UpdaterEvent = apps.get_model("main", "UpdaterEvent")
    for event in TwitchalertsEvent.objects.all():
        try:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('twitchalerts', '0002_twitchalertsupdate_refresh_before'),
    ]
