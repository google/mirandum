...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='twitchalertsevent',
            name='updater',
            field=models.ForeignKey(to='twitchalerts.TwitchalertsUpdate'),
