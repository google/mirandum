...
#    url(r'^stream1/$', RedisQueueView.as_view(redis_channel="foo"), name="stream1"),
    ...
    url(r'^beam/unlink/(?P<id>[0-9]+)', 'beam.views.unlink'),
    url(r'^beam/unlink_confirm/(?P<id>[0-9]+)', 'beam.views.unlink_confirm'),
    url(r'^beam/setup', 'beam.views.setup'),
    url(r'^beam/oauth2callback', 'beam.views.auth_return'),
    url(r'^beam/$', 'beam.views.home'),
    url(r'^beam/setup$', 'beam.views.setup'),
    url(r'^beam/test_alert/(?P<alert_id>[0-9]*)$', 'beam.views.test_alert'),
    url(r'^beam/alert$', 'beam.views.alert_config'),
    url(r'^beam/alert/(?P<alert_id>[0-9]*)$', 'beam.views.alert_config'),
    url(r'^mixer/unlink/(?P<id>[0-9]+)', 'beam.views.unlink'),
    url(r'^mixer/unlink_confirm/(?P<id>[0-9]+)', 'beam.views.unlink_confirm'),
    url(r'^mixer/setup', 'beam.views.setup'),
    url(r'^mixer/oauth2callback', 'beam.views.auth_return'),
    url(r'^mixer/$', 'beam.views.home'),
    url(r'^mixer/setup$', 'beam.views.setup'),
    url(r'^mixer/test_alert/(?P<alert_id>[0-9]*)$', 'beam.views.test_alert'),
    url(r'^mixer/alert$', 'beam.views.alert_config'),
    url(r'^mixer/alert/(?P<alert_id>[0-9]*)$', 'beam.views.alert_config'),
    ...
    url(r'^counters/$', 'meta.views.setup'),
    url(r'^counters/counter$', 'meta.views.meta_config'),
    url(r'^counters/counter/(?P<meta_id>[0-9]+)$', 'meta.views.meta_config'),
